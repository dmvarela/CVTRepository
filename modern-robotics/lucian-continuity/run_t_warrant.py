...
PROBE_FILE = ROOT / "probes" / "t_warrant_probes_v003.json"
PROTOCOL_VERSION = "t-warrant-0.03-mechanistic"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run the v0.03 warrant-sensitive T experiment against local Ollama."
    )
    ...
    if args.out:
        ...
        output_path = RESULTS_DIR / f"{stamp}_{safe_model}_t_warrant_v003.jsonl"
